...
<table border="1" cellpadding="2" width="100%">
    <tr>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <th>
                <input type="submit" name="new" value="New MODULE" title="Generate a new MODULE entry"
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <th>
                <input type="submit" name="first" value="Goto First MODULE" title="Go to the first added MODULE"
                    style="font-size: 10pt">
                <input type="submit" name="prev" value="Goto Previous MODULE"
                    title="Go to the MODULE before the currently selected one" style="font-size: 10pt">
                <input type="submit" name="next" value="Goto Next MODULE"
                    title="Go to the MODULE after the currently selected one" style="font-size: 10pt">
                <input type="submit" name="last" value="Goto Last MODULE" title="Go to the last added MODULE"
                    style="font-size: 10pt">
            </th>
        </form>
    </tr>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <table border="1" cellpadding="2" width="100%">
        ...
        <tr>
            <td align="left" colspan="1" style="width: 300px; white-space: nowrap;">
                Pitch adaptor ID: <input type="text" name="pitch_adaptor_id" value="<?php echo $pitch_adaptor_id; ?>"
                    size="20">
            </td>
            <td align="left" colspan="1" style="width: 300px; white-space: nowrap;">
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1" cellpadding="2" width="100%">
        ...
        <tr>
            ...
            <td>
                Feedthru Position:
                <?php generate_dropdown('feedthru_position', $feedthru_positions, $feedthru_position); ?>
            </td>
            <td>
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                ...
                <td><input type="text" name="trace_high_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'trace_high_comments_' . $amp}; ?>" size="40"></td>
                <td><input type="text" name="trace_high_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'trace_high_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                ...
                <td><input type="text" name="image1_high_noise_<?php echo $amp; ?>"
                        value="<?php echo ${'image1_high_noise_' . $amp}; ?>"></td>
                <td><input type="text" name="image1_high_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image1_high_comments_' . $amp}; ?>" size="40"></td>
                <td><input type="text" name="image1_high_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image1_high_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                <td><?php echo "ch" . $count . " (ext" . $count_plus . ")"; ?></td>
                <td><input type="text" name="image2_high_column_defects_<?php echo $amp; ?>"
                        value="<?php echo ${'image2_high_column_defects_' . $amp}; ?>"></td>
                <td><input type="text" name="image2_high_noise_<?php echo $amp; ?>"
                        value="<?php echo ${'image2_high_noise_' . $amp}; ?>"></td>
                <td><input type="text" name="image2_high_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image2_high_comments_' . $amp}; ?>" size="40"></td>
                <td><input type="text" name="image2_high_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image2_high_reference_' . $amp}; ?>" size="20"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                <td><?php echo "ch" . $count . " (ext" . $count_plus . ")"; ?></td>
                <td><input type="text" name="image3_high_res_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_high_res_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_high_gain_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_high_gain_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_high_dark_current_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_high_dark_current_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_high_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_high_comments_' . $amp}; ?>" size="30"></td>
                <td><input type="text" name="image3_high_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_high_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                <td><?php echo "ch" . $count . " (ext" . $count_plus . ")"; ?></td>
                <td><input type="text" name="image4_high_pixel_defects_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_pixel_defects_' . $amp}; ?>"></td>
                <td><input type="text" name="image4_high_column_defects_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_column_defects_' . $amp}; ?>"></td>
                <td><input type="text" name="image4_high_region_defect_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_region_defect_' . $amp}; ?>" size="10"></td>
                <td><input type="text" name="image4_high_noise_overscan_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_noise_overscan_' . $amp}; ?>"></td>
                <td><input type="text" name="image4_high_cti_code_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_cti_code_' . $amp}; ?>" size="10"></td>
                <td>
                ...
                <td><input type="text" name="image4_high_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_comments_' . $amp}; ?>" size="40"></td>
                <td><input type="text" name="image4_high_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_high_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                <td><?php echo "ch" . $count . " (ext" . $count_plus . ")"; ?></td>
                <td><input type="text" name="image3_low_res_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_low_res_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_low_gain_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_low_gain_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_low_dark_current_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_low_dark_current_' . $amp}; ?>"></td>
                <td><input type="text" name="image3_low_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_low_comments_' . $amp}; ?>" size="30"></td>
                <td><input type="text" name="image3_low_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image3_low_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
    ...
    <table border="1">
        ...
        foreach ($ccds as $amp):
            ...
            <tr>
                ...
                <td><input type="text" name="image4_low_peak1_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_low_peak1_' . $amp}; ?>" size="15"></td>
                <td><input type="text" name="image4_low_peak2_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_low_peak2_' . $amp}; ?>" size="15"></td>
                <td><input type="text" name="image4_low_sigma_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_low_sigma_' . $amp}; ?>" size="15"></td>
                <td>
                    <?php generate_dropdown('image4_low_front_' . $amp, $yes_no_blank_array, ${'image4_low_front_' . $amp}); ?>
                </td>
                <td><input type="text" name="image4_low_comments_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_low_comments_' . $amp}; ?>" size="40"></td>
                <td><input type="text" name="image4_low_reference_<?php echo $amp; ?>"
                        value="<?php echo ${'image4_low_reference_' . $amp}; ?>" size="50"></td>
            </tr>
            <?php
            $count++;
            $count_plus++;
