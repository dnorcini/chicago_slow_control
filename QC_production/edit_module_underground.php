    ...
    <table border="1" cellpadding="2" width="100%">
        ...
        <tr>
            <td colspan="4" align="center" style="white-space: nowrap;">
                ...
                $seq_high_file_name = 'seq_high_file.seq';
                $seq_high_file_path = $upload_dir . $seq_high_file_name;
                $bcf_high_file_name = 'bcf_high_file.bcf';
                $bcf_high_file_path = $upload_dir . $bcf_high_file_name;
                $seq_low_file_name = 'seq_low_file.seq';
                $seq_low_file_path = $upload_dir . $seq_low_file_name;
                $bcf_low_file_name = 'bcf_low_file.bcf';
                $bcf_low_file_path = $upload_dir . $bcf_low_file_name;

                // seq_high
                if (file_exists($seq_high_file_path) && !isset($_SESSION['file_url_' . $module_underground_id]['seq_high_file'])) {
                    $_SESSION['file_url_' . $module_underground_id]['seq_high_file'] = $base_url . $seq_high_file_name;  // Use base_url for the web link
                }
                if (!empty($seq_high_file_name) && file_exists($seq_high_file_path)) {
                    $file_exists = true;
                ...
                // bcf high
                if (file_exists($bcf_high_file_path) && !isset($_SESSION['file_url_' . $module_underground_id]['bcf_high_file'])) {
                    $_SESSION['file_url_' . $module_underground_id]['bcf_high_file'] = $base_url . $bcf_high_file_name;  // Use base_url for the web link
                }
                if (!empty($bcf_high_file_name) && file_exists($bcf_high_file_path)) {
                    $file_exists2 = true;
                ...
                // seq_low
                if (file_exists($seq_low_file_path) && !isset($_SESSION['file_url_' . $module_underground_id]['seq_low_file'])) {
                    $_SESSION['file_url_' . $module_underground_id]['seq_low_file'] = $base_url . $seq_low_file_name;  // Use base_url for the web link
                }
                if (!empty($seq_low_file_name) && file_exists($seq_low_file_path)) {
                    $file_exists3 = true;
                    $file_url3 = $_SESSION['file_url_' . $module_underground_id]['seq_low_file'];
                } else {
                    $file_exists3 = false;
                }
                // bcf high
                if (file_exists($bcf_low_file_path) && !isset($_SESSION['file_url_' . $module_underground_id]['bcf_low_file'])) {
                    $_SESSION['file_url_' . $module_underground_id]['bcf_low_file'] = $base_url . $bcf_low_file_name;  // Use base_url for the web link
                }
                if (!empty($bcf_low_file_name) && file_exists($bcf_low_file_path)) {
                    $file_exists4 = true;
                    $file_url4 = $_SESSION['file_url_' . $module_underground_id]['bcf_low_file'];
                } else {
                    $file_exists4 = false;
                }
                ...
                <?php endif; ?>
                <label id="seq_high_file" for="seq_high_file">High Temp Sequencer:</label>
                ...
                <?php endif; ?>
                <label id="bcf_high_file" for="bcf_high_file">High Temp bcf:</label>
        ...
        <tr>
            <td colspan="4" align="center" style="white-space: nowrap;">
                ...
                <?php endif; ?>
                <label id="seq_low_file" for="seq_low_file">Low Temp Sequencer:</label>
                <input type="file" name="seq_low_file" accept=".seq, application/octet-stream">
                &nbsp; &nbsp; &nbsp; &nbsp;

                <?php if ($file_exists4): ?>
                    <a href="<?php echo htmlspecialchars($file_url4); ?>" target="_blank">
                        <img src="pixmaps/icon2.png" alt="bcf_low_file" style="height: 20px; width: auto;">
                    </a>
                <?php endif; ?>
                <label id="bcf_low_file" for="bcf_low_file">Low Temp bcf:</label>
                <input type="file" name="bcf_low_file" accept=".bcf, application/octet-stream">
                &nbsp; &nbsp; &nbsp; &nbsp;
            </td>
...
<!-- HIGH TEMP -->
<!-- Trace Section -->
<?php echo "<b>Trace and PSD, High Temp</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        <tr>
            <td colspan="9" align="left" style="border: none; white-space: nowrap;">
                ...
                if (file_exists($trace_high_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['trace_high_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['trace_high_log'] = $base_url . $trace_high_log_name;  // Use base_url for the web link
                }
                ...
                if (!empty($trace_high_log_name) && file_exists($trace_high_log_path)) {
                    ...
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['trace_high_log'];
                } else {
...
<?php echo "<b>Image 1, High Temp - [1 skip, 20x20 binning, 80rx320c, Active Region, 3s Exposure] - Aim: To see tracks</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        ?>
            <tr>
                ...
                <td align="center"><input type="text" style="width: 90%;" name="image1_high_reference_<?php echo $amp; ?>" value="<?php echo ${'image1_high_reference_' . $amp}; ?>"></td>
            </tr>
        <?php
            $count++;
            $count_plus++;
        ...
        <tr>
            <td align="left" colspan="9" style="border: none; white-space: nowrap;">
                ...
                if (file_exists($image1_high_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['image1_high_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['image1_high_log'] = $base_url . $image1_high_log_name;  // Use base_url for the web link
                }
                ...
                if (!empty($image1_high_log_name) && file_exists($image1_high_log_path)) {
                    // Log exists, keep the session variables and show the icon
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['image1_high_log'];
                } else {
                    // Log does not exist, clear the session variables and remove the icon
                    $log_exists = false;
                }
...
<?php echo "<b>Image 2, High Temp - [1 skip, 1x1 binning, 30rx6400c, Serial Register, 10s Exposure] - Aim: Serial Register Defects</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        ?>
            <tr>
                ...
                <td align="center"><input type="text" style="width: 90%;" name="image2_high_reference_<?php echo $amp; ?>" value="<?php echo ${'image2_high_reference_' . $amp}; ?>"></td>
            </tr>
        <?php
            $count++;
            $count_plus++;
...
<?php echo "<b>Image 3-1, High Temp - [500 skip, 1x1 binning, 30rx640c, Serial Register, 0s Exposure] - Aim: Single Electron Resolution</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        <tr>
            <td align="left" colspan="9" style="border: none; white-space: nowrap;">
                ...
                $image31_high_log_name = 'image31_high_log.log';
                $image31_high_log_path = $upload_dir . $image31_high_log_name;  // Use the absolute server path for file_exists()
                ...
                // If image31_high_log exists in the directory but no session is set, initialize the session
                if (file_exists($image31_high_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['image31_high_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['image31_high_log'] = $base_url . $image31_high_log_name;  // Use base_url for the web link
                }

                // Check if the log exists on the server (log system path)
                if (!empty($image31_high_log_name) && file_exists($image31_high_log_path)) {
                    // Log exists, keep the session variables and show the icon
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['image31_high_log'];
                } else {
                    // Log does not exist, clear the session variables and remove the icon
                    $log_exists = false;
                }
                ...
                <?php if ($log_exists): ?>
                    <a href="<?php echo htmlspecialchars($log_url); ?>" target="_blank">
                        <img src="pixmaps/icon2.png" alt="Image31_High Log" style="height: 20px; width: auto;">
                    </a>
                <?php endif; ?>
                <label for="image31_high_log">Log File:</label>
                <input type="file" name="image31_high_log" accept=".log,text/plain">
            </td>
        </tr>
    </table>
</form>
...
<?php echo "<b>Image 3-2, High Temp - [1000 skip, 1x1 binning, 30rx640c, Serial register, 0s Exposure] - Aim: Single Electron Resolution </b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        <tr>
            <td align="left" colspan="9" style="border: none; white-space: nowrap;">
                ...
                $image32_high_log_name = 'image32_high_log.log';
                $image32_high_log_path = $upload_dir . $image32_high_log_name;  // Use the absolute server path for file_exists()
                ...
                // If image32_high_log exists in the directory but no session is set, initialize the session
                if (file_exists($image32_high_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['image32_high_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['image32_high_log'] = $base_url . $image32_high_log_name;  // Use base_url for the web link
                }

                // Check if the log exists on the server (log system path)
                if (!empty($image32_high_log_name) && file_exists($image32_high_log_path)) {
                    // Log exists, keep the session variables and show the icon
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['image32_high_log'];
                } else {
                    // Log does not exist, clear the session variables and remove the icon
                    $log_exists = false;
                }
                ...
                <?php endif; ?>
                <label for="image32_high_log">Log File:</label>
                <input type="file" name="image32_high_log" accept=".log,text/plain">
            </td>
        </tr>
    </table>
</form>
...
<?php echo "<b>Image 4, High Temp - [1 skip, 1x1 binning, 1600rx6400c, Active region, 500s Exposure] - Aim: Defect Map, Sharpness of tracks, CTI, Noise, CCD channel mapping</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
...
<?php echo "<b>Image 3-1, Low Temp - [500 skip, 1x1 binning, 30rx640c, Serial Register, 0s Exposure] - Aim: Single Electron Resolution</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        <tr>
            <td align="left" colspan="9" style="border: none; white-space: nowrap;">
                ...
                $image31_low_log_name = 'image31_low_log.log';
                $image31_low_log_path = $upload_dir . $image31_low_log_name;  // Use the absolute server path for file_exists()
                ...
                // If image31_low_log exists in the directory but no session is set, initialize the session
                if (file_exists($image31_low_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['image31_low_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['image31_low_log'] = $base_url . $image31_low_log_name;  // Use base_url for the web link
                }

                // Check if the log exists on the server (log system path)
                if (!empty($image31_low_log_name) && file_exists($image31_low_log_path)) {
                    // Log exists, keep the session variables and show the icon
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['image31_low_log'];
                } else {
                    // Log does not exist, clear the session variables and remove the icon
                    $log_exists = false;
                }
                ...
                <?php if ($log_exists): ?>
                    <a href="<?php echo htmlspecialchars($log_url); ?>" target="_blank">
                        <img src="pixmaps/icon2.png" alt="Image31_Low Log" style="height: 20px; width: auto;">
                    </a>
                <?php endif; ?>
                <label for="image31_low_log">Log File:</label>
                <input type="file" name="image31_low_log" accept=".log,text/plain">
            </td>
        </tr>
    </table>
</form>
...
<?php echo "<b>Image 3-2, Low Temp - [1000 skip, 1x1 binning, 30rx640c, Serial Register, 0s Exposure] - Aim: Single Electron Resolution</b>"; ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <table border="1">
        <tr>
        ...
        <tr>
            <td align="left" colspan="9" style="border: none; white-space: nowrap;">
                ...
                $image32_low_log_name = 'image32_low_log.log';
                $image32_low_log_path = $upload_dir . $image32_low_log_name;  // Use the absolute server path for file_exists()
                ...
                // If image32_low_log exists in the directory but no session is set, initialize the session
                if (file_exists($image32_low_log_path) && !isset($_SESSION['log_url_' . $module_underground_id]['image32_low_log'])) {
                    $_SESSION['log_url_' . $module_underground_id]['image32_low_log'] = $base_url . $image32_low_log_name;  // Use base_url for the web link
                }

                // Check if the log exists on the server (log system path)
                if (!empty($image32_low_log_name) && file_exists($image32_low_log_path)) {
                    // Log exists, keep the session variables and show the icon
                    $log_exists = true;
                    $log_url = $_SESSION['log_url_' . $module_underground_id]['image32_low_log'];
                } else {
                    // Log does not exist, clear the session variables and remove the icon
                    $log_exists = false;
                }
                ...
                <?php if ($log_exists): ?>
                    <a href="<?php echo htmlspecialchars($log_url); ?>" target="_blank">
                        <img src="pixmaps/icon2.png" alt="Image32_Low Log" style="height: 20px; width: auto;">
                    </a>
                <?php endif; ?>
                <label for="image32_low_log">Log File:</label>
                <input type="file" name="image32_low_log" accept=".log,text/plain">
            </td>
        </tr>
    </table>
</form>
...
<!-- Image4 Low Temp -->
<?php echo "<b>Image 4, Low Temp - [1 skip, 1x1 binning, 1600rx6400c, Active region, 500s Exposure] - Aim: Defect Map, Sharpness of tracks, CTI, Noise, CCD channel mapping</b>"; ?>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_reference_<?php echo $amp; ?>" value="<?php echo ${'image4_low_reference_' . $amp}; ?>"></td>
    ...
    <!-- FRONT CTI-->
    <?php echo "<b>Image 4, Low Temp - Frontside CTI</b>"; ?>

    <table border="1">

        <tr>
            <td align="center" style="width: 10%; white-space: nowrap;">Amplifier</td>
            <td align="center" style="width: 10%; white-space: nowrap;">Left Fraction</td>
            ...
            <td align="center" style="width: 10%; white-space: nowrap;">Below Fraction</td>
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_cti_front_below_fraction_<?php echo $amp; ?>" value="<?php echo ${'image4_low_cti_front_below_fraction_' . $amp}; ?>"></td>
    ...
    <!-- BACKSIDE CTI-->
    <?php echo "<b>Image 4, Low Temp - Backside CTI</b>"; ?>

    <table border="1">

        <tr>
            <td align="center" style="width: 12%; white-space: nowrap;">Amplifier</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Left Mean</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Left RMS</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Left Skewness</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Left Integral</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Below Mean</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Below RMS</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Below Skewness</td>
            <td align="center" style="width: 11%; white-space: nowrap;">Below Integral</td>
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_cti_back_below_mean_<?php echo $amp; ?>" value="<?php echo ${'image4_low_cti_back_left_mean_' . $amp}; ?>"></td>
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_cti_back_below_rms_<?php echo $amp; ?>" value="<?php echo ${'image4_low_cti_back_left_rms_' . $amp}; ?>"></td>
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_cti_back_below_skewness_<?php echo $amp; ?>" value="<?php echo ${'image4_low_cti_back_left_skewness_' . $amp}; ?>"></td>
                <td align="center"> <input type="text" style="width: 90%;" name="image4_low_cti_back_below_integral_<?php echo $amp; ?>" value="<?php echo ${'image4_low_cti_back_left_integral_' . $amp}; ?>"></td>
...
<!-- Image5 Low Temp -->
<?php echo "<b>Image 5, Low Temp - [500 skip, 1x1 binning, 320rx640c, Active region, 500s Exposure] - Aim: High Resolution Fe55 Cluster Analysis, CTI, noise </b>"; ?>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image5_low_reference_<?php echo $amp; ?>" value="<?php echo ${'image5_low_reference_' . $amp}; ?>"></td>
            </tr>
        <?php
            $count++;
            $count_plus++;
    ...
    <!-- FRONT CTI-->
    <?php echo "<b>Image 5, Low Temp - Frontside CTI</b>"; ?>
    ...
    <!-- BACKSIDE CTI-->
    <?php echo "<b>Image 5, Low Temp - Backside CTI</b>"; ?>
    ...
    <!-- CROSSTALK-->
    <?php echo "<b>Image 5, Low Temp - Crosstalk</b>"; ?>

    <table border="1">

        <tr>
            <td align="center" style="width: 12%; white-space: nowrap;"> </td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch0 & ch1</td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch0 & ch2</td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch0 & ch3</td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch1 & ch2</td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch1 & ch3</td>
            <td align="center" style="width: 11%; white-space: nowrap;">ch2 & ch3</td>


        </tr>

        <?php // here *_A is just easier for field def in php, the crosstalk is between amplifiers 
        ?>
        <tr>
            <td align="center"><?php echo "Crosstalk" ?></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_01_A" value="<?php echo ${'image5_low_crosstalk_01_A'}; ?>"></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_02_A" value="<?php echo ${'image5_low_crosstalk_02_A'}; ?>"></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_03_A" value="<?php echo ${'image5_low_crosstalk_03_A'}; ?>"></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_12_A" value="<?php echo ${'image5_low_crosstalk_12_A'}; ?>"></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_13_A" value="<?php echo ${'image5_low_crosstalk_13_A'}; ?>"></td>
            <td align="center"> <input type="text" style="width: 90%;" name="image5_low_crosstalk_23_A" value="<?php echo ${'image5_low_crosstalk_23_A'}; ?>"></td>
        </tr>
        <tr>
            <td align="center">Comment</td>
            <td align="center" colspan="6">
                <input type="text" style="width: 90%;" name="image5_low_crosstalk_comments_A" value="<?php echo ${'image5_low_crosstalk_comments_A'}; ?>">
            </td>
        </tr>
...
<!-- Image6 Low Temp -->
<?php echo "<b>Image 6, Low Temp - [500 skip, 10x1 binning, 320rx640c, Active region, 500s Exposure] - Aim: High Resolution Fe55 Cluster Analysis, CTI, noise</b>"; ?>
    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image6_low_reference_<?php echo $amp; ?>" value="<?php echo ${'image6_low_reference_' . $amp}; ?>"></td>
            </tr>
        <?php
            $count++;
            $count_plus++;
    ...
    <table border="1">
        ...
        ?>
            <tr>
                ...
                <td align="center"> <input type="text" style="width: 90%;" name="image7_low_reference_<?php echo $amp; ?>" value="<?php echo ${'image7_low_reference_' . $amp}; ?>"></td>
